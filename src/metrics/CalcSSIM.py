...
def calc_ssim(folder_Gen, folder_GT, result_save_path, epoch):
    ...
    for i, img_path in enumerate(img_list):
        ...
        video_name, frame_name, _  = base_name.rsplit('_', 2)
        GT_imgName = video_name + "/" + frame_name + '.png'
    
        im_GT = cv2.imread(os.path.join(folder_GT, "SDSD_CUHK/videoSDSD_normal_resize", GT_imgName)) / 255.
